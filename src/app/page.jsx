...
export default function Home() {
  ...
  const photos = [
    { src: "/img.jpg", alt: "Happy times" },
    { src: "/img2.jpg", alt: "Special moment" },
    { src: "/img3.jpg", alt: "Us together" },
    { src: "/img4.jpg", alt: "Happy times" },
    { src: "/img5.jpg", alt: "Us together" },
    { src: "/img6.jpg", alt: "Memories" },
    { src: "/img7.jpg", alt: "Special moment" },
    { src: "/img8.jpg", alt: "Happy times" },
    { src: "/img9.jpg", alt: "Memories" },
    //{ src: "/img10.jpg", alt: "Memories 💖" },
    { src: "/img11.jpg", alt: "Memories" },
    //{ src: "/img12.jpg", alt: "Memories" },
    { src: "/img13.jpg", alt: "Special moment" },
    //{ src: "/img14.jpg", alt: "Memories 💖" },
    //{ src: "/img15.jpg", alt: "Memories 💖" },
    //{ src: "/img16.jpg", alt: "Memories 💖" },
    //{ src: "/img17.jpg", alt: "Memories 💖" },
  ]

  // Change this message according to you
  const message = `Dear Love,
Being with you has been the most beautiful journey of my life. Every moment we’ve shared feels like a precious blessing, and I treasure each day we've spent together.
From the very first time we met until now, you’ve filled my life with happiness, laughter, and unconditional love. Your smile lights up even my darkest days, and your love gives me strength when I need it most.
As we celebrate another year of togetherness, I want you to know that my love for you grows stronger every single day. You are not just my partner — you’re my best friend, my greatest support, and the one my heart belongs to.
Happy Anniversary, my love! Here’s to many more years of love, laughter, and beautiful memories together.
With all my heart,
Me`
        ...
        {loading ? (
          ...
          <>
            ...
            >
              ...
              >
                <p className="text-lg font-medium">Dinidu ❤️ Rashmika</p>
              </motion.footer>
            </motion.div>
          </>
        )}
